...
2. Swin Transformer — nắm bắt quan hệ toàn cục qua cơ chế self-attention
Hai mô hình được kết hợp bằng Weighted Soft Voting với cơ chế Adaptive Weighting đặc biệt cho nhóm lớp khó (MY, MMY, PMY).

KẾT QUẢ:
Mô hình ResNet50 đạt 94.01% Accuracy, 0.9220 F1-Macro
Swin-S đạt 94.49% Accuracy, 0.9260 F1-Macro
Ensemble đạt 94.91% Accuracy, 0.9317 F1-Macro
